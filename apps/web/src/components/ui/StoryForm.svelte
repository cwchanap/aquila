...
<form onsubmit={(e) => { e.preventDefault(); onSubmit(); }} class="space-y-6">
    <div>
        <label for="story-title" class="block text-sm font-medium text-gray-300 mb-2">
    ...
    <div>
        <label for="story-description" class="block text-sm font-medium text-gray-300 mb-2">
            Description
        </label>
        <textarea
    ...
    <div>
        <label for="story-status" class="block text-sm font-medium text-gray-300 mb-2">
            Status
        </label>
        <select
            id="story-status"
