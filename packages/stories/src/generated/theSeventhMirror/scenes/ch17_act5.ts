...
export const scene: DialogueEntry[] = [
    ...
    { characterId: CharacterId.AsakuraMio, character: "朝倉澪", dialogue: "（內心）⋯⋯先看正常的。再看不正常的。把兩個放在一起比。這樣才知道哪一輛不對勁。", background: Background.Chapter_17_Ch17_Act5_S0, portrait: Portrait.AsakuraMio_Determined },
    ...
    { characterId: CharacterId.AsakuraMio, character: "朝倉澪", dialogue: "（內心）⋯⋯雙艙。外面是作業艙——升降板、固定架、搬送工具，都看得見。裡面是封閉的。不透明內門、隔板、第二層簾。三層遮蔽。什麼都看不見。沒有人，沒有擔架，沒有設備。什麼都沒有。", background: Background.Chapter_17_Ch17_Act5_S0, portrait: Portrait.AsakuraMio_Determined },
