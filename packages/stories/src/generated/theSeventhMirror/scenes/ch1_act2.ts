...
export const scene: DialogueEntry[] = [
    ...
    { characterId: CharacterId.AsakuraMio, character: "朝倉澪", dialogue: "⋯⋯這是什麼。", background: Background.Chapter_1_Ch1_Act2_S0, portrait: Portrait.AsakuraMio_Base },
    { characterId: CharacterId.AsakuraYuma, character: "悠真", dialogue: "妳每次都在嫌東嫌西，偶爾也照照鏡子吧。", background: Background.Chapter_1_Ch1_Act2_S0, portrait: Portrait.AsakuraYuma_Base },
    { characterId: CharacterId.Narrator, character: "旁白", dialogue: "澪當時罵他亂講話，把鏡子扔回他桌上。悠真沒生氣，反而笑得很得意，像真的送了什麼不得了的禮物——那種「我知道妳嘴上嫌、手會收」的笑。", background: Background.Chapter_1_Ch1_Act2_S0 },
    ...
    { characterId: CharacterId.Narrator, character: "旁白", dialogue: "真正知道悠真早餐不吃青椒的人，只有澪。", background: Background.Chapter_1_Ch1_Act2_S1 },
    { characterId: CharacterId.Narrator, character: "旁白", dialogue: "知道他忘記帶眼鏡會頭痛的人，也只有澪。", background: Background.Chapter_1_Ch1_Act2_S1 },
    { characterId: CharacterId.Narrator, character: "旁白", dialogue: "睡前一定要把手把線繞成那團亂樣——這件事，還是只有澪知道。", background: Background.Chapter_1_Ch1_Act2_S1 },
