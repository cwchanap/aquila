...
test.describe('Change Password API Tests', () => {
  ...
  test('API should accept valid password change request', async ({ page }) => {
    // Make API request to change password
    const response = await page.request.post('/api/simple-auth/change-password', {
      headers: {
  ...
  test('should allow login with new password after change', async ({ page }) => {
